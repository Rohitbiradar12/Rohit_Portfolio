...
const techStackImgs = [
  { id: "react", name: "React", imgPath: "/images/logos/react.png", color: "#61DAFB", category: "Frontend", proficiency: 92, experience: "3+ years", projects: 15 },
  { id: "javascript", name: "JavaScript", imgPath: "/images/logos/javascript.svg", color: "#F7DF1E", category: "Frontend", proficiency: 95, experience: "4+ years", projects: 20 },
  { id: "typescript", name: "TypeScript", imgPath: "/images/logos/typescript.png", color: "#3178C6", category: "Frontend", proficiency: 85, experience: "2+ years", projects: 10 },
  { id: "html5", name: "HTML5", imgPath: "/images/logos/html5.svg", color: "#E34F26", category: "Frontend", proficiency: 98, experience: "4+ years", projects: 25 },
  { id: "css3", name: "CSS3", imgPath: "/images/logos/css3.svg", color: "#1572B6", category: "Frontend", proficiency: 95, experience: "4+ years", projects: 25 },
  { id: "threejs", name: "Three.js", imgPath: "/images/logos/three.png", color: "#000000", category: "Frontend", proficiency: 70, experience: "1+ year", projects: 3 },
  { id: "tailwind", name: "Tailwind", imgPath: "/images/logos/tailwind.svg", color: "#06B6D4", category: "Frontend", proficiency: 88, experience: "2+ years", projects: 12 },
  
  { id: "java", name: "Java", imgPath: "/images/logos/java.webp", color: "#ED8B00", category: "Backend", proficiency: 90, experience: "3+ years", projects: 8 },
  { id: "springboot", name: "Spring Boot", imgPath: "/images/logos/spring.png", color: "#6DB33F", category: "Backend", proficiency: 88, experience: "2+ years", projects: 6 },
  { id: "nodejs", name: "Node.js", imgPath: "/images/logos/node.png", color: "#339933", category: "Backend", proficiency: 85, experience: "2+ years", projects: 10 },
  { id: "python", name: "Python", imgPath: "/images/logos/python.svg", color: "#3776AB", category: "Backend", proficiency: 80, experience: "2+ years", projects: 5 },
  { id: "csharp", name: "C#", imgPath: "/images/logos/c-sharp.webp", color: "#512BD4", category: "Backend", proficiency: 75, experience: "1+ year", projects: 3 },
  { id: "aspnet", name: "ASP.NET", imgPath: "/images/logos/.NET.png", color: "#512BD4", category: "Backend", proficiency: 72, experience: "1+ year", projects: 2 },
  
  { id: "mongodb", name: "MongoDB", imgPath: "/images/logos/mongo.png", color: "#47A248", category: "Database", proficiency: 85, experience: "2+ years", projects: 8 },
  { id: "postgresql", name: "PostgreSQL", imgPath: "/images/logos/postgres.png", color: "#4169E1", category: "Database", proficiency: 88, experience: "2+ years", projects: 6 },
  { id: "oracledb", name: "OracleDB", imgPath: "/images/logos/OracleDB.png", color: "#F80000", category: "Database", proficiency: 80, experience: "1+ year", projects: 4 },
  { id: "mysql", name: "MySQL", imgPath: "/images/logos/mySQL.png", color: "#4479A1", category: "Database", proficiency: 85, experience: "2+ years", projects: 5 },
  { id: "sqldev", name: "SQL Developer", imgPath: "/images/logos/SQL.png", color: "#CC2927", category: "Database", proficiency: 82, experience: "2+ years", projects: 4 },
  { id: "redis", name: "Redis", imgPath: "/images/logos/redis.png", color: "#DC382D", category: "Database", proficiency: 78, experience: "1+ year", projects: 3 },
  
  { id: "docker", name: "Docker", imgPath: "/images/logo3.png", color: "#2496ED", category: "DevOps", proficiency: 85, experience: "2+ years", projects: 10 },
  { id: "kubernetes", name: "Kubernetes", imgPath: "/images/logos/kubernetes.png", color: "#326CE5", category: "DevOps", proficiency: 75, experience: "1+ year", projects: 4 },
  { id: "terraform", name: "Terraform", imgPath: "/images/logos/terraform.png", color: "#7B42BC", category: "DevOps", proficiency: 70, experience: "1+ year", projects: 3 },
  { id: "aws", name: "AWS", imgPath: "/images/logos/aws.png", color: "#FF9900", category: "DevOps", proficiency: 82, experience: "2+ years", projects: 8 },
  { id: "azure", name: "Azure", imgPath: "/images/logos/azure.png", color: "#0078D4", category: "DevOps", proficiency: 75, experience: "1+ year", projects: 4 },
  { id: "kafka", name: "Kafka", imgPath: "/images/logos/kafka.png", color: "#231F20", category: "DevOps", proficiency: 72, experience: "1+ year", projects: 2 },
  { id: "git", name: "Git", imgPath: "/images/logos/git.svg", color: "#F05032", category: "DevOps", proficiency: 95, experience: "4+ years", projects: 30 },
];
