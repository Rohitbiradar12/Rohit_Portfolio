...
const Experience = () => {
  ...
  return (
    <section
      id="experience"
      ref={sectionRef}
      className="relative flex-center md:mt-24 mt-12 section-padding xl:px-0 overflow-hidden"
    >
      ...
      <div className="relative z-10 w-full h-full md:px-20 px-5">
        <TitleHeader title={<>Professional Work <span className="text-purple-accent gradient-text">Experience</span></>} />
